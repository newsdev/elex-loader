...
function accept_prez_ap_calls {
    psql elex_$RACEDATE -c "UPDATE override_races o set accept_ap_calls = True from elex_races e WHERE o.race_raceid=e.race_raceid and e.officeid = 'P';"
}

function ignore_prez_ap_calls {
    psql elex_$RACEDATE -c "UPDATE override_races o set accept_ap_calls = False from elex_races e WHERE o.race_raceid=e.race_raceid and e.officeid = 'P';"
}